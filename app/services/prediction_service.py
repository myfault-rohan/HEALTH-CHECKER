...
symptoms_conditions = {
    ...
    # Cold & Stress (newly added)
    "cold": {
        "conditions": [
            {"name": "Common Cold", "severity": "low", "score": 2},
            {"name": "Seasonal Cold", "severity": "low", "score": 1},
            {"name": "Upper Respiratory Infection", "severity": "medium", "score": 2},
            {"name": "Allergic Rhinitis", "severity": "low", "score": 1},
        ],
        "remedies": [
            "🍵 Drinking hot Tulsi-ginger tea with honey",
            "🌿 Inhaling steam with eucalyptus or mint leaves",
            "🌿 Consuming turmeric milk (Golden Milk) before bed",
            "🌿 Taking giloy (Tinospora) juice for immunity",
            "🥕 Eating vitamin C-rich foods (amla, oranges, guava)",
            "💧 Drinking warm fluids throughout the day",
            "😴 Getting adequate rest and staying warm",
            "🌿 Gargling with warm salt water twice daily",
        ]
    },
    "stress": {
        "conditions": [
            {"name": "Chronic Stress", "severity": "medium", "score": 2},
            {"name": "Anxiety", "severity": "medium", "score": 2},
            {"name": "Burnout", "severity": "medium", "score": 2},
            {"name": "Stress-related Headache", "severity": "low", "score": 1},
            {"name": "Sleep Disorder", "severity": "low", "score": 1},
        ],
        "remedies": [
            "🧘 Practicing daily meditation and Pranayama (deep breathing)",
            "🌿 Taking ashwagandha churna with warm milk",
            "🌿 Drinking Brahmi tea for mental clarity and calm",
            "🌿 Consuming jatamansi (spikenard) for relaxation",
            "🧘 Doing 20-minute Yoga Nidra before sleep",
            "🍵 Sipping chamomile or lavender tea in the evening",
            "😴 Maintaining a consistent sleep schedule (7-8 hours)",
            "🌿 Using shankhapushpi for calming the mind",
            "🍎 Eating magnesium-rich foods (bananas, nuts, dark chocolate)",
        ]
    }
}
